...
import zhou.com.snailbook.ui.activity.MainActivity;
...
import zhou.com.snailbook.ui.presenter.RecommendPresenter;
...
public class RecommendFragment extends BaseRVFragment<RecommendPresenter, Recommend.RecommendBooks> implements RecommendContract.View, RecyclerArrayAdapter.OnItemLongClickListener {
    ...
    @BindView(R.id.llBatchManagement) LinearLayout llBatchManagement;
    @BindView(R.id.tvSelectAll) TextView tvSelectAll;
